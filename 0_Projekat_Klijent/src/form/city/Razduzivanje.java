 ...
 * @author s
 */
public class Razduzivanje extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Citonica:");

        jLabel2.setText("Studenti:");

        jButton1.setText("vratiZaduzenja");

        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        jLabel3.setText("Zauduzenja:");

        jButton2.setText("Izbrisi zaduzenje");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Razduzivanje.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Razduzivanje().setVisible(true);
            }
        });
    }
